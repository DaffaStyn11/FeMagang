        ...
        <ul class="flex text-white">
          <li>
            <div class="flex items-center">
              ...
              <span class="ml-2">Digital Center, Dinas Komunikasi, Kabupaten Mojokerto, Jatim</span>
            </div>
          </li>
          <li class="ml-6">
            <div class="flex items-center">
      ...
      <div class="hidden md:block w-full md:w-auto" id="menu">
        <nav
          ...
          <ul class="md:flex items-center">
            ...
            <li class="md:ml-4"><a class="py-2 inline-block md:text-white md:px-2 font-semibold" href="#">Treatments</a>
            </li>
            <li class="md:ml-4"><a class="py-2 inline-block md:text-white md:px-2 font-semibold" href="#">Testimonials</a>
            </li>
            ...
            <li class="md:ml-6 mt-3 md:mt-0">
              <a
                class='inline-block font-semibold px-4 py-2 text-white bg-blue-600 md:bg-transparent md:text-white border border-white rounded-full hover:text-black'>Login</a>
            </li>
          </ul>
        </nav>
      </div>
