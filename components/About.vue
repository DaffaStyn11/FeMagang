        ...
        <div class="flex flex-col md:flex-row lg:-mx-8">
            <div class="w-full lg:w-1/2 lg:px-8">
                ...
                <p class="mt-2 leading-relaxed">
                    Donec convallis sollicitudin facilisis. Integer nisl ligula, accumsan
            ...
            <div class="w-full lg:w-1/2 lg:px-8">
                <div class="flex">
                    ...
                    <div class="ml-8">
                        ...
                        <p class="mt-2 leading-relaxed">
                            Our comprehensive services allow you to receive all needed dental
                            care right here in our state-of-art office – from dental cleanings
                            and fillings to dental implants and extractions.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex mt-8">
                    ...
                    <div class="ml-8">
                        ...
                        <p class="mt-2 leading-relaxed">
                            ...
                            dentist, we can help. Our comfortable office, compassionate team,
                            and minimally-invasive treatments will help you feel completely at
                            ease.
                        </p>
                    </div>
                </div>
        ...
        <div class="flex flex-col md:flex-row mt-24 text-center md:-mx-4">
            <div class="bg-white rounded-lg shadow-lg p-8 md:mx-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-6" width="77" height="80" viewBox="0 0 77 80">
                    <path d="M51 0a26 26 0 1 1-26 26A26 26 0 0 1 51 0z" fill="#bee3f8" />
                    <path
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 md:mx-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-6" width="85" height="80" viewBox="0 0 85 80">
                    <path d="M59 0a26 26 0 1 1-26 26A26 26 0 0 1 59 0z" fill="#bee3f8" />
                    <path
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 md:mx-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-6" width="65" height="80" viewBox="0 0 65 80">
                    <path d="M39 0a26 26 0 1 1-26 26A26 26 0 0 1 39 0z" fill="#bee3f8" />
                    <path
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 md:mx-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-6" width="82" height="80" viewBox="0 0 82 80">
                    <path d="M56 0a26 26 0 1 1-26 26A26 26 0 0 1 56 0z" fill="#bee3f8" />
                    <path
